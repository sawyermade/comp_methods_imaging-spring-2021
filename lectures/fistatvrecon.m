function [reconstruction] = fistatvrecon(A, measurement, lambda_val, numpixels_xy)
...
%     
    ...
    [r_opt] = fista_backtrack(grad, prox, testr, 1e-8, 1,  struct('lambda',lambda_val(1)), calc_H, calc_G, constants);
